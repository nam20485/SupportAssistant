...
> **My feedback:** Resolved by #13 — tasks are full sub-issues, not issue-linked checklist items.
...
> **My feedback:** _Add your response here (e.g., "apply all" or list exceptions)._
...
| 2 | What is a phase in GitHub terms — milestone, project field, or iteration? (#2) | _pending_ |
| 3 | Does a milestone map to a phase or a release? (#4) | _pending_ |
| 4 | Are defects in scope for the first version? (#6) | _pending_ |
| 5 | Should templates also be mirrored to `.github/ISSUE_TEMPLATE/` for manual use? (#11) | _pending_ |
| 6 | What language/runtime should the scripts target (pwsh vs bash)? (#10) | _pending_ |
